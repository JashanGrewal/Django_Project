...
urlpatterns = [
   ...
   # path('adduser',views.AddUser , name='adduser'),
    ...
    url(r'^con_profile/$',views.con_profile , name='con_profile'),
    url(r'^profile/$',views.profile_view , name='profile_view'),
    url(r'^profile_edit/$',views.update_profile , name='update_profile'),
    url(r'^login/$', auth_views.LoginView.as_view(template_name='con_login.html',redirect_authenticated_user=True), name='login'),
    url(r'^labour_signup/$',views.labour_signup, name='labour_signup'),
